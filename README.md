...
- Practical Methods to Optimise Model Stability: A Case Study Using Customer-Lifetime Value at Farfetch
  ...
  Co-presented with Kishan Manani.
...
- [How to interpret sMAPE just like MAPE](https://medium.com/@davide.sarra/how-to-interpret-smape-just-like-mape-bf799ba03bdc)
- [Slow BigQuery results no more](https://medium.com/@davide.sarra/slow-bigquery-results-no-more-8aa4dde92613)
- [How to test magics in IPython extensions](https://medium.com/@davide.sarra/how-to-test-magics-in-ipython-extensions-86d99e5d6802)

### 🛠️ Open Source

- [`jupyter-spaces`](https://pypi.org/project/jupyter-spaces)

### 📍 Where Am I

- [LinkedIn](https://www.linkedin.com/in/davidesarra)
- [Medium](https://medium.com/@davide.sarra)
- And here on [GitHub](https://github.com/davidesarra)
